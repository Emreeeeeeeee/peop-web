...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const testimonials = [
        {
            ...
            company: "Ford Otosan",
            logo: "images/marka-logo/ford-otosan-logo.png"
        },
        {
            ...
            logo: "images/marka-logo/mercedes-benz-logo.png"
        },
        {
            ...
            company: "SunExpress",
            logo: "images/marka-logo/sunexpress-logo-1.png"
        }
    ];
    ...
    function showTestimonial(idx) {
        ...
        setTimeout(() => {
            ...
            avatarEl.innerHTML = '<img src="' + t.logo + '" alt="' + t.company + '" style="height:28px;width:auto">';
    ...
    if (kvkkLink && kvkkOverlay) {
        kvkkLink.addEventListener('click', e => { e.preventDefault(); kvkkOverlay.classList.add('active'); });
        kvkkClose.addEventListener('click', () => kvkkOverlay.classList.remove('active'));
        kvkkOverlay.addEventListener('click', e => { if (e.target === kvkkOverlay) kvkkOverlay.classList.remove('active'); });
    }
